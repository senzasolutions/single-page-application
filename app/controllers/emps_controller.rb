class EmpsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @emp.save
        format.html { redirect_to emp_url(@emp), notice: "THANK YOU" }
  ...
  def update
    respond_to do |format|
      if @emp.update(emp_params)
        format.html { redirect_to emp_url(@emp), notice: "DATA was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to emps_url, notice: "Data was successfully destroyed." }
  ...
  private
    ...
    def emp_params
      params.require(:emp).permit(:employer, :date_start, :date_end)
    end
end
